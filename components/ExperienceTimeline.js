...
const experience = [
  {
    ...
    highlights: [
      "Designed and deployed AWS, GCP, and Azure infrastructure with Terraform; cut provisioning time ~50%.",
      "Accelerated release cadence 40% with Jenkins, Docker, and Azure DevOps pipelines.",
      "Scaled Kubernetes on AKS, GKE, EKS using Helm; built full observability with Prometheus, Grafana, and Loki.",
      "Led Banregio banking migration (AWS → Azure) with zero data loss and financial compliance.",
      "Secured container images via Qualys QScanner, reducing critical CVEs by 90%.",
    ],
    tags: ["AWS", "Azure", "GCP", "Terraform", "Kubernetes", "ArgoCD", "Python"],
  },
  {
